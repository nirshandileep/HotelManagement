                ...
                <td>
                    ...
                    <table class="customers-tbl">
                        ...
                        <tr>
                            ...
                            <td>
                                <dx:ASPxTextBox ID="txtMemberCodeGrp" runat="server" TabIndex="2" Width="170px" Enabled="False"
                                    EnableTheming="True" BackColor="#CFEEF3">
                                </dx:ASPxTextBox>
                            </td>
                            <td>
                                &nbsp;
                ...
                <td>
                    <table border="0" cellpadding="0" cellspacing="0" id="customer-info-btn-tbl">
                        <tr>
                            ...
                            <td width="52" align="left">
                                <dx:ASPxButton ID="btnClear" runat="server" Text="New" HorizontalAlign="Center"
